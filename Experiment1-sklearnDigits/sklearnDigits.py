...
output_dir = os.path.join('fit_sklearn_multiple_models', model_name)
os.makedirs(output_dir, exist_ok=True)
csv_file_path = os.path.join(output_dir, f'model_{model_name}_test_train_accuracy_and_paramters.csv')
...
model_dir = os.path.join('fit_sklearn_multiple_models', model_name)
digit_dir = os.path.join(model_dir, f'digit_{target_digit}', f'replicate_{replicate}')
run_evolution(toolbox, ngen=5000, model=trained_model, input_shape=input_shape, target_digit=target_digit, output_subdir=digit_dir, generation_interval=generation_interval)
